  ...
  devServer: {
    before(app){
      ...
      app.get('/api/getSongLyric', function(req, res) {
        ...
        axios.get(url, { headers: {
          origin: 'https://y.qq.com',
          referer: `https://y.qq.com/n/yqq/song/${req.params.id}.html`
        },
          params: req.query
        }).then((response) => {
          res.json(response.data)
      ...
      app.get('/api/getDiscSong', function(req, res) {
        ...
        axios.get(url, { headers: {
          origin: 'https://y.qq.com',
          referer: `https://y.qq.com/n/yqq/playlist/${req.params.did}.html`
        },
          params: req.query
        }).then((response) => {
          res.json(response.data)
      ...
      app.get('/api/getRankSong', function(req, res) {
        ...
        axios.get(url, { headers: {
          origin: 'https://y.qq.com',
          referer: `https://y.qq.com/n/yqq/toplist/${req.params.id}.html`
        },
          params: req.query
        }).then((response) => {
          res.json(response.data)
      ...
      app.get('/api/getSearchContent', function(req, res) {
      ...
      app.post('/api/getSongsUrl',bodyparser.json(),function (req, res) {
        var url = 'https://u.y.qq.com/cgi-bin/musicu.fcg'
